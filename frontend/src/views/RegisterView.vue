  ...
  <div class="container row-2xl">
    <section id="registerID" class="w-6/12 mx-auto mt-[180px] bg-transparent dark:bg-gray-900 rounded-2xl">
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        <h1 id="login-title" class="text-xl font-bold leading-tight tracking-tight
           text-yellow-500 text-center md:text-2xl dark:text-white">
          Создание аккаунта
        </h1>
        ...
        <form @submit.prevent="register" class="space-y-4 md:space-y-6">
          <div id="login-username" class="flex justify-between items-center gap-6">
            <img src="../assets/icons/user.png" width="40" height="40" alt="user" />
          ...
          <div id="login-email" class="flex justify-between items-center gap-6">
            <img src="../assets/icons/email.png" width="40" height="40" alt="user" />
          ...
          <div id="login-password" class="flex justify-between items-center gap-6">
            <img src="../assets/icons/password.png" width="40" height="40" alt="user" />
