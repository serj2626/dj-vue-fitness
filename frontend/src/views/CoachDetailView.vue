...
<template>
  ...
  <div v-if="showModal">
    <CreateOrderTrain v-model:date="dateTrain" v-model:rate="rateTrain" :lastName="coach.last_name"
      :firstName="coach.first_name" :position="coach.position" :id="coach.id" @closeModal="showModal = false"
