        ...
        <form class="mx-auto flex max-w-md gap-x-4">
            ...
            <input id="email-address" name="email" type="email" autocomplete="email"
             required class="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2
              ...
              focus:ring-inset focus:ring-white sm:text-sm sm:leading-6" placeholder="Введите вашу почту">

            <button type="submit" class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold
             text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2
              focus-visible:outline-offset-2 focus-visible:outline-white">Подписаться</button>
        </form>
