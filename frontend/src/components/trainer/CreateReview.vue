...
<template>
    <form @submit.prevent="createReview" class="py-6 px-4 w-full mx-auto flex flex-col items-center gap-5">
        <div class="card flex justify-center">
            <Rating v-model="form.rating" />
        </div>
        <div class="flex justify-center items-start w-full">
            <textarea class="w-full border-0 outline-none p-2 rounded-md" placeholder="Введите отзыв"
            ...
            <button type="submit"
                ...
                <svg class="w-5 h-5 rotate-90 rtl:-rotate-90 text-yellow-400 hover:text-yellow-300" aria-hidden="true"
