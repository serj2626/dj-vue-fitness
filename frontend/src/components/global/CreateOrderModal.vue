...
<template>
  ...
  <fwb-modal v-if="orderType === 'training'" @close="$emit('closeModal')">
    ...
    <template #footer>
      <div class="flex justify-between">
        ...
        <fwb-button size="lg" @click="$emit('createOrderTraining')" color="green">
          Записаться
        </fwb-button>
      </div>
    </template>
  ...
  <fwb-modal v-if="orderType === 'abonement'" @close="$emit('closeModal')">
    ...
    <template #body>
      ...
      <input v-model="date" class="w-full my-3 p-2 border border-gray-300 rounded" type="date" />
    </template>
    <template #footer>
      <div class="flex justify-between">
        <fwb-button size="lg" @click="$emit('closeModal')" color="red">
        ...
        <fwb-button size="lg" @click="$emit('crateOrderAbonement')" color="green">
          Забронировать
        </fwb-button>
      </div>
    </template>
