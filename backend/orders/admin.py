...
class OrderTrainingAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'trainer', 'start',
                    'end', 'get_rate_title', 'get_rate_price', 'get_rate_count_minutes', 'status', 'active', )
...
class AbonementAdmin(admin.ModelAdmin):
    ...
    list_display = ("id", 'title', 'price',
                    'description', 'number_of_months', )
    list_editable = ('title', 'price', 'description', 'number_of_months', )
...
class OrderAbonementAdmin(admin.ModelAdmin):
    ...
    list_display = ('user', 'phone', 'abonement',
                    'start', 'end', 'get_number_of_months', 'get_price', 'status', 'active')
